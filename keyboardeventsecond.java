...
public class keyboardeventsecond {
	...
	public static void main(String[] args) {
		...
		WebElement current = driver.findElement(By.id("current Address"));
		WebElement permanent = driver.findElement(By.id("permanent Address"));
		
	Actions action = new Actions(driver);
//	1.enter the value  in current address tab
	 current.sendKeys("pune");
	 
	 //we will select the all the values form current address
	 action.keyDown(Keys.CONTROL);
	 action.sendKeys("a");
	 		
//	 Key up method will use to realse the giveb key
